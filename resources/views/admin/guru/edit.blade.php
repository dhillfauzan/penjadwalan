                ...
                <div class="card border-0 shadow-sm p-4 mb-4" style="border-radius: 16px;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_guru') is-invalid @enderror" 
                               id="nama_guru" name="nama_guru" value="{{ old('nama_guru', $guru->nama_guru) }}" placeholder="Masukkan nama lengkap beserta gelar" required style="border-radius: 10px;">
                        @error('nama_guru')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nip') is-invalid @enderror" 
                               id="nip" name="nip" value="{{ old('nip', $guru->nip) }}" placeholder="Masukkan NIP resmi" required style="border-radius: 10px;">
                        @error('nip')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jk_l" value="L" {{ old('jenis_kelamin', $guru->jenis_kelamin) == 'L' ? 'checked' : '' }} required>
                            <label class="form-check-label font-weight-500" for="jk_l">Laki-laki</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jk_p" value="P" {{ old('jenis_kelamin', $guru->jenis_kelamin) == 'P' ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_telp') is-invalid @enderror" 
                               id="no_telp" name="no_telp" value="{{ old('no_telp', $guru->no_telp) }}" placeholder="contoh: 0812XXXXXXXX" style="border-radius: 10px;">
                        @error('no_telp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="card border-0 shadow-sm p-4 mb-4" style="border-radius: 16px;">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-outline-danger btn-xs" id="btn-clear-all" style="border-radius: 6px; padding: 0.2rem 0.6rem; font-size: 0.8rem;">
                                Hapus Semua Jam
                            </button>
                        </div>
                    </div>
